...
\section{Current Java Interoperability}\label{sec:bg}
	...
	(.toString aClass)
	;;This returns the string "Hello, world!" because the method-toString function 
	...
	When you call toString on one of these objects it will return the correct result depending on the type of the object in question. 
